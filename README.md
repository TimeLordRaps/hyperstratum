...
├── docs/
│   ├── 00-orientation.md
│   ├── 01-form-frame-base-meta-hyper.md
│   ├── 02-hyperstack.md
│   └── 03-graph-prefix-grammar.md
├── specs/
│   ├── canonical-definitions.md
│   └── dependency-graph.md
└── examples/
    ├── person-hypernode.md
    └── force-of-will-bridge.md
```

## Status

This repo is an initial ontology scaffold. Definitions are canonical enough to reference, but notation and formal tests remain open.
